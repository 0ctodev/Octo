...
static const CAmount OBFUSCATION_COLLATERAL = (8 * COIN);
...
{
public:
    /// Is the inputs associated with this public key? (and there is 10000 OCTO - checking if valid masternode)
...
public:
    ...
    /// Get the denominations for a specific amount of octo.
