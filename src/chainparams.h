...
// Copyright (c) 2015-2017 The OCTO Core developers
 ...
 * OCTO system. There are three: the main network on which people trade goods
...
public:
    ...
    std::string DevelopmentAddress() const { return strDevelopmentAddress; }
...
protected:
    ...
    std::string strDevelopmentAddress;
