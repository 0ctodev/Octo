...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* OCTO features */
        {"octo", "masternode", &masternode, true, true, false},
        {"octo", "listmasternodes", &listmasternodes, true, true, false},
        {"octo", "getmasternodecount", &getmasternodecount, true, true, false},
        {"octo", "masternodeconnect", &masternodeconnect, true, true, false},
        {"octo", "masternodecurrent", &masternodecurrent, true, true, false},
        {"octo", "masternodedebug", &masternodedebug, true, true, false},
        {"octo", "startmasternode", &startmasternode, true, true, false},
        {"octo", "createmasternodekey", &createmasternodekey, true, true, false},
        {"octo", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"octo", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"octo", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"octo", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"octo", "getmasternodescores", &getmasternodescores, true, true, false},
        {"octo", "mnbudget", &mnbudget, true, true, false},
        {"octo", "preparebudget", &preparebudget, true, true, false},
        {"octo", "submitbudget", &submitbudget, true, true, false},
        {"octo", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"octo", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"octo", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"octo", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"octo", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"octo", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"octo", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"octo", "checkbudgets", &checkbudgets, true, true, false},
        {"octo", "mnsync", &mnsync, true, true, false},
        {"octo", "spork", &spork, true, true, false},
        {"octo", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"octo", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    return "> octo-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:58584/\n";
}
