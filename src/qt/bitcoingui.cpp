                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("OCTO Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a OCTO address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and octo: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zOCTO"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About OCTO Core"), this);
    aboutAction->setStatusTip(tr("Show information about OCTO Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for OCTO"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your OCTO addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified OCTO addresses"));
    ...
    openAction->setStatusTip(tr("Open a OCTO: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the OCTO Core help message to get a list with possible OCTO command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("OCTO Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to OCTO network", "", count));
}
...
{
    QString strTitle = tr("OCTO Core"); // default title
