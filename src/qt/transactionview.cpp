 ...
 */
    ...
    typeWidget->addItem(tr("Received Octo from zOcto"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zOcto"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zOcto));
