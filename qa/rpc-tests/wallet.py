...
#   c) node1 mines 32 blocks, so now node 0 has 60001Octo, node 1 has 4250Octo, node2 has none.
#   d) node0 sends 601 Octo to node2, in two transactions (301 Octo, then 300 Octo).
