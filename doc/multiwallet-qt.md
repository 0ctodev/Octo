...
In order to support loading of multiple wallets in octo-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is octo.cpp.
...
Changes to octo.cpp
----------------------
octo.cpp is the entry point into octo-qt, and as such, will require some minor modifications to provide hooks for
