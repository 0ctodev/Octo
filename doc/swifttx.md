...
This mechanism has been integrated into Bitcore-Node-OCTO which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/octo-team/insight-api-octo#web-socket-api](https://github.com/octo-team/insight-api-octo#web-socket-api) 
* API: [https://github.com/octo-team/insight-api-octo#swifttx-transactions](https://github.com/octo-team/insight-api-octo#swifttx-transactions) 
...
By default, the OCTO Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the OCTO Core daemon:
